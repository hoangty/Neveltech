...
const icon = require.context('../../assets/images/icon', false, /\.(png|jpe?g|svg)$/);
  ...
  const Service = () => (
    <section className="mb-xl pt-lg">
      <div className="w-[1440px] mx-auto grid grid-cols-7 gap-[10px] border-b border-[rgba(255,255,255,0.04)] pb-[30px]">
        <a href="#" className='md:flex justify-center items-center rounded-lg overflow-hidden h-[57px] p-4 border border-[rgba(255,255,255,0.1)] hover:bg-[rgba(255,255,255,0.3)] duration-200'>
        ...
        <a href="#" className='md:flex justify-center items-center rounded-lg overflow-hidden h-[57px] p-4 border border-[rgba(255,255,255,0.1)] bg-[#12294A] hover:bg-[rgba(255,255,255,0.3)] duration-200'>
